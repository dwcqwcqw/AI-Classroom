...
// Updated to use nested structure matching JSON files and code usage
export const settingsZhCN = {
  settings: {
    ...
    mineruCloudOcrLabel: '启用 OCR（is_ocr）',
    mineruCloudOcrHint:
      '扫描件、拍照页建议开启；纯矢量 PDF 可关闭。对应官网精准解析 API 的 files[].is_ocr。',
    mineruCloudPageRangesLabel: '页码范围（可选）',
    mineruCloudPageRangesPlaceholder: '例如 5-30 或 2,4-6，留空则解析全文档（最多 200 页）',
    mineruCloudModelVersionLabel: '模型版本（model_version）',
    mineruCloudModelVlm: 'vlm（推荐）',
    mineruCloudModelPipeline: 'pipeline',
    mineruCloudModelHtml: 'MinerU-HTML（仅 HTML 源文件）',
...
export const settingsEnUS = {
  settings: {
    ...
    qwenVoiceMarcus: 'Broad face, short words, solid heart',
    ...
    mineruCloudOcrLabel: 'Enable OCR (is_ocr)',
    mineruCloudOcrHint:
      'Recommended for scans; maps to MinerU precise-parse API files[].is_ocr.',
    mineruCloudPageRangesLabel: 'Page ranges (optional)',
    mineruCloudPageRangesPlaceholder:
      'e.g. 5-30 or 2,4-6; leave empty for full document (up to 200 pages)',
    mineruCloudModelVersionLabel: 'Model version (model_version)',
    mineruCloudModelVlm: 'vlm (recommended)',
    mineruCloudModelPipeline: 'pipeline',
    mineruCloudModelHtml: 'MinerU-HTML (HTML sources only)',
