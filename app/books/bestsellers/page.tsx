...
export default async function BestsellerBooksPage() {
  const books = (await getLibraryBooks()).filter((b) => b.bestseller);

  return (
    <main className="min-h-[100dvh] bg-slate-50 dark:bg-slate-950 px-6 py-8">
      <div className="mx-auto max-w-6xl">
        <div className="mb-6 flex items-center justify-between">
          <h1 className="text-3xl font-extrabold tracking-tight md:text-4xl">畅销图书</h1>
